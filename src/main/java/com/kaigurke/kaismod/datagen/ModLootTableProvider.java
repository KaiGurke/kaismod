...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        addDrop(ModBlocks.STRIPPED_GREEN_MANGROVE_LOG_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_LOG_KEY);
        addDrop(ModBlocks.STRIPPED_GREEN_MANGROVE_WOOD_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_WOOD_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_PLANKS_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_BUTTON_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_PRESSURE_PLATE_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_SLAB_KEY, slabDrops(ModBlocks.GREEN_MANGROVE_SLAB_KEY));
        addDrop(ModBlocks.GREEN_MANGROVE_FENCE_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_FENCE_GATE_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_DOOR_KEY, doorDrops(ModBlocks.GREEN_MANGROVE_DOOR_KEY));
        addDrop(ModBlocks.GREEN_MANGROVE_TRAPDOOR_KEY);
        addDrop(ModBlocks.GREEN_MANGROVE_STAIRS_KEY);
