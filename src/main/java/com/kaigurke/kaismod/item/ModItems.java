...
public class ModItems {
    ...
    public static final RegistryKey<ItemGroup> KAISMOD_BLOCKS_GROUP_KEY = RegistryKey.of(Registries.ITEM_GROUP.getKey(), Identifier.of(KaisMod.MOD_ID, "block_group"));
    public static final ItemGroup KAISMOD_BLOCKS_GROUP = FabricItemGroup.builder()
		.icon(() -> new ItemStack(ModBlocks.GREYBOX_PLACEHOLDER_KEY.asItem()))
		.displayName(Text.translatable("itemGroup.kaismod.blocks"))
		.build();
    ...
    public static final Item JETT_SMOKE = registerItem("smoke_charge", new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM,Identifier.of(KaisMod.MOD_ID, "smoke_charge")))));
